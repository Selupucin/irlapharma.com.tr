    ...
    <section class="features section--nopb">
        <div class="container">
            <div class="features_header">
                <h2 class="features_header-title">Nasıl Çalışıyoruz</h2>
                <p class="features_header-text">
                    Sizler için en uygun şekilde ulaşım sağlıyoruz.
                </p>
            </div>
            <ul class="features-list d-md-flex flex-wrap justify-content-xl-between">
                <li class="features-list_item col-md-6 col-xl-3 d-flex flex-column align-items-center" data-order="1"
                    data-aos="fade-up">
                    ...
                    <h4 class="title">Ücretsiz Teslimat & İade</h4>
                    <!--<p class="text">Quis risus sed vulputate odio ut. Arcu vitae elementum curabitur vitae nunc</p>-->
                </li>
                <li class="features-list_item col-md-6 col-xl-3 d-flex flex-column align-items-center" data-order="2"
                    data-aos="fade-up">
                    <span class="icon d-flex align-items-center justify-content-center">
                    ...
                    <h4 class="title">Para İade Garantili</h4>
                    <!--<p class="text">Quis risus sed vulputate odio ut. Arcu vitae elementum curabitur vitae nunc</p>-->
                </li>
                <li class="features-list_item col-md-6 col-xl-3 d-flex flex-column align-items-center" data-order="3"
                    data-aos="fade-up">
                    <span class="icon d-flex align-items-center justify-content-center">
                    ...
                    <h4 class="title">7/24 Destek</h4>
                    <!--<p class="text">Quis risus sed vulputate odio ut. Arcu vitae elementum curabitur vitae nunc</p>-->
                </li>
                <li class="features-list_item col-md-6 col-xl-3 d-flex flex-column align-items-center" data-order="4"
                    data-aos="fade-up">
                    <span class="icon d-flex align-items-center justify-content-center">
                    ...
                    <h4 class="title">100% Güvenli Ödeme</h4>
                    <!--<p class="text">Quis risus sed vulputate odio ut. Arcu vitae elementum curabitur vitae nunc</p>-->
                </li>
            </ul>
        </div>
